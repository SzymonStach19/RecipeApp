...
Kolacja::Kolacja(const std::string &kategoria) {
    string linia;
...
string Kolacja::wyswietlNazwyPrzepisow() {
...
string Kolacja::wyswietlNazwePrzepisu(int indeks) {
    string nazwaprzepisu;
...
string Kolacja::wyswietlOcenyPrzepisu(int indeks, int wybor) {
    string nazwaoceny;
    if (wybor == 1) {
...
string Kolacja::wyswietlCiekawostki(int indeks) {
    string ciekawostki;
...
string Kolacja::wyswietlSkladnikiPrzepisu(int indeks) {
...
string Kolacja::wyswietlNazwyPrzypraw(int indeks) {
...
string Kolacja::wyswietlKrokiPrzepisu(int indeks, std::string decyzja, int numerkroku) {
    string nazwakroku;
    if (decyzja == "t") {
