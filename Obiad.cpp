...
Obiad::Obiad(const std::string &kategoria) {
    string linia;
...
string Obiad::wyswietlNazwyPrzepisow() {
...
string Obiad::wyswietlNazwePrzepisu(int indeks) {
    string nazwaprzepisu;
...
string Obiad::wyswietlOcenyPrzepisu(int indeks, int wybor) {
    string nazwaoceny;
    if (wybor == 1) {
...
string Obiad::wyswietlCiekawostki(int indeks) {
    string ciekawostki;
...
string Obiad::wyswietlSkladnikiPrzepisu(int indeks) {
...
string Obiad::wyswietlNazwyPrzypraw(int indeks) {
...
string Obiad::wyswietlKrokiPrzepisu(int indeks, std::string decyzja, int numerkroku) {
    string nazwakroku;
    if (decyzja == "t") {
